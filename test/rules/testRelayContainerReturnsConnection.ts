...
describe('RelayContainerReturnsConnection rule', () => {
  ...
  it('disallows types that end in ConnectionContainer but that are not objects', () => {
    expectFailsRule(
      RelayContainerReturnsConnection,
      gql`
        scalar ScalarConnectionContainer

        interface InterfaceConnectionContainer {
          a: String!
        }
        ...
        union UnionConnectionContainer = F

        enum EnumConnectionContainer {
          SOMETHING
        }

        input InputConnectionContainer {
          a: String!
        }
      `,
      [
        {
          ...
          message:
            'Types that end in `ConnectionContainer` must be an object type as per the relay spec. `ScalarConnectionContainer` is not an object type.',
        },
        {
          locations: [
            {
          ...
          message:
            'Types that end in `ConnectionContainer` must be an object type as per the relay spec. `InterfaceConnectionContainer` is not an object type.',
        },
        {
          locations: [
            {
          ...
          message:
            'Types that end in `ConnectionContainer` must be an object type as per the relay spec. `UnionConnectionContainer` is not an object type.',
        },
        {
          locations: [
            {
          ...
          message:
            'Types that end in `ConnectionContainer` must be an object type as per the relay spec. `EnumConnectionContainer` is not an object type.',
        },
        {
          locations: [
            {
          ...
          message:
            'Types that end in `ConnectionContainer` must be an object type as per the relay spec. `InputConnectionContainer` is not an object type.',
        },
      ],
    );
  });
