    ...
    return {
        ObjectTypeDefinition(node) {
            ...
            if (((_a = node.interfaces) === null || _a === void 0 ? void 0 : _a.some((iface) => iface.name.value == 'Node')) &&
                ...
                context.reportError(new utils.validation_error.ValidationError('nodes-contain-entity-id', `The Node type \`${node.name.value}\` must have a non-nullable "entityId" string.`, [node]));
            }
        },
    };
}
